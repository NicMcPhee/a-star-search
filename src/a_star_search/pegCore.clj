...
(defn -main
  ...
  [& args]
  (let [start-state (np/->State [[0 1 3] [4 2 5] [7 8 6]] [0 0]) ;START-STATE: addition of array= array.legnth-1
        goal-state (np/->State [[0 1 2] [3 4 5] [6 7 8]] [0 0]) ; END-STATE: addition of array = 1
        max-states 1000000
        costs nil
